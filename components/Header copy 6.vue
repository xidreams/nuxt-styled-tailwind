<template>
    ...
    <ul class="menu">
        ...
        <li><a href="#news">Mailbox Accounts</a></li>
        <li class="dropdown">
            <a href="javascript:void(0)" class="dropbtn">Account Management <span class="arrow">▼</span></a>
            <div class="dropdown-content mega-menu">
                <div class="row">
                    <div class="column">
                        <h3>Service Accounts</h3>
                        <a href="#">Create New Service Account</a>
                        <a href="#">List of Accounts Owned</a>
                        <a href="#">Password Refresh</a>
                    </div>
                    <div class="column">
                        <h3>Guest Accounts</h3>
                        <a href="#">List of Accounts Owned</a>
                        <a href="#">Create New Guest</a>
                        <a href="#">Delete Guests</a>
                    </div>
                </div>
            </div>
        </li>
